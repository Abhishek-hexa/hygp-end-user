...
export const FeatureTabButton = ({
  ...
  return (
    <button
      ...
      className={`flex shrink-0 items-center justify-center rounded-full border-2 px-4 py-1 font-ranchers text-base lg:text-lg font-normal tracking-[1px] transition-colors ${
